...
namespace MT.OnlineRestaurant.AccountManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //addedd
            //"Server=(localdb)\\v11.0;Database=CustomerManagement;Trusted_Connection=True;MultipleActiveResultSets=true;";
            services.AddDbContext<CustomerManagementContext>(item => item.UseSqlServer("Server=(localdb)\\v11.0;Database=AccountManagement;Trusted_Connection=True;MultipleActiveResultSets=true;",
