...
namespace MT.OnlineRestaurant.UT
{
    ...
    public class SearchRepositoryTest
    {
        ...
        //{
        //    //Arrange
        //    List<MultipleSearchFeature> search = new List<MultipleSearchFeature>();
        //    search.Add(new MultipleSearchFeature()
        //    {
        //         rating = 1,
        //         cuisine = "Florida",
        //         Menu = "Dosa",
        //         RestaurantName = "Zeejubin International "
        //    });
        //    var mockOrder = new Mock<IRestaurantBusiness>();
        //    mockOrder.Setup(x => x.SearchForRestaurantBasedOnMultipleFeactures()).Returns(search.AsQueryable());
